        ...
        <section className="min-h-screen flex items-stretch text-white ">
            <div className="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center" style={{backgroundImage: `url(${liol})`}}>
                ...
                <div className="w-full px-24 z-10">
                    ...
                    <p className="text-3xl my-4">"Unlock the door to endless creativity – Sign up for MyNotebook and let your ideas flourish!"</p>
                </div>
            ...
            <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style={{backgroundColor: "#161616"}}>
                ...
                <div className="w-full py-6 z-20">
                    ...
                    <div className="pb-2 pt-4">
                            <input type="name" name="name" id="name" placeholder="Name" onChange={onChange} value={credentials.name} className="block w-full p-4 text-lg rounded-sm bg-black"/>
                        </div>
                        ...
                        {/* <div className="pb-2 pt-4">
                            <input className="block w-full p-4 text-lg rounded-sm bg-black" onChange={onChange} value={credentials.password} type="cpassword" name="cpassword" id="cpassword" placeholder="Confirm Password"/>
                        </div> */}
                        ...
                        <div className="px-4 pb-2 pt-4">
                            <button onClick={handleClick}  disabled={credentials.name.length<3 || credentials.email.length<10 || credentials.password.length<6} className="uppercase block w-full p-4 text-lg rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none">Sign Up</button>
                        </div>
