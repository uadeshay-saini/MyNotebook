...
import MyNotebook from './MyNotebook.gif'
function Navbar(props) {
    ...
    <div className="relative flex h-16 items-center justify-between">
      ...
      <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        <div className="flex flex-shrink-0 items-center">
          <img className="h-12 w-auto" src={MyNotebook} alt="Your Company"/>
        </div>
      ...
      <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        ...
        {localStorage.getItem('token')?<div className="hidden sm:ml-6 sm:block">
          <div className="flex space-x-4">
            <Link onClick={handleLogout} className="bg-blue-900 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Logout</Link>
           </div>
        </div> :
        <div className="hidden sm:ml-6 sm:block">
          <div className="flex space-x-4">
 ...
 <div className="hidden sm:ml-6 sm:block">
          <div className="flex space-x-4">
          {/* bg-teal-900 */}
            <Link to="/" className="text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">{props.name}</Link>
           </div>
        </div>
          ...
          <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Sign Up</button> */}
        <div className="relative ml-3">
          ...
          {/* <div className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
            ...
            <Link  className="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-2">Sign out</Link>
          </div> */}
        </div>
      </div>
    </div>
